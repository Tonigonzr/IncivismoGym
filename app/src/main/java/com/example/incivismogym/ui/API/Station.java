...
public class Station {
    ...
    @JsonProperty("extra")
    private com.example.incivismogym.ui.API.Extra extra;
    ...
    @JsonProperty("extra")
    public com.example.incivismogym.ui.API.Extra getExtra() {
        return extra;
    }

    @JsonProperty("extra")
    public void setExtra(com.example.incivismogym.ui.API.Extra extra) {
        this.extra = extra;
    }
